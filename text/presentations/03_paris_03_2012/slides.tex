...
\DefineNamedColor{named}{mygraylight}{cmyk}{0.01,0.01,0.01,0.01}
...
\begin{frame}
  ...
  \begin{block}{Potential Problem}
    truth-value judgement/rating tasks make it impossible to separate:
      ...
      \item picture~complexity/stereotypicality \hfill {\color{gray}{\citep[cf.][]{Tielvan-Tiel2012:Embedded-Scalar}}}
      \end{enumerate}
...
\begin{frame}
  ...
  \end{block}
    ...
    \begin{itemize}
    \item ``local'' in \AE\ \ \urltilde \  ``local'' in \GE \hfill
      (Pearson, $r = .7$, $p < .01$)
    \end{itemize}
  \end{block}
