\documentclass[fleqn,10pt,xcolor=dvipsnames]{beamer}
...
\setbeamercolor*{block title}{fg=mycol,bg=mygraylight}
...
% Logo auf Titelseite
\titlegraphic{\pgfimage[height=0.75cm]{ILLCLOGO.pdf}}
%--------------------------------------
...
\begin{frame}
  ...
  \begin{block}{\AE \hfill (Global)}
    \begin{exe}
      \exr{bsp:AE} All of the students read {\color{mycol}{some}} of the
      papers.
    \ex All of the students read {\color{mycol}{all}} of the papers.
    \ex
      \begin{xlist}
  ...
  \begin{block}{\AE  \hfill (Local)}
    ...
    \ex
      \begin{xlist}
      \ex All of the students read {\color{mycol}{some  but not all}} of the papers.
...
\begin{frame}[shrink=2]
  ...
  \begin{block}{\GE \hfill (Global)}
    \begin{exe}
      \exr{bsp:GE} Exactly one of the students read {\color{mycol}{some}} of the
      papers.
...
\begin{frame}
  ...
  \begin{block}{Reading GE \hfill (summary)}
    ...
    \begin{multicols}{2}
      \begin{itemize}
      \item[] \lit\ $\supset$ \glb\ $\color{mycol}{\subset}$ \loc
      \item[] \lit\ $\not \supset$ \loc
      \end{itemize}
    \end{multicols}
    \vspace{-0.15cm}
...
\begin{frame}
  ...
  \begin{block}{Distinguishing Cases \GE \hfill (false)}
    ...
    \begin{minipage}[c]{0.45\linewidth}
        \vspace{0pt}
    ``Exactly one of the dots on the left is connected to some of the dots on
    the right.''
    \medskip
...
\begin{frame}
  \frametitle{Scalar Items in Embedded Positions}
  \begin{block}{Distinguishing Cases \GE \hfill (literal)}
...
\begin{frame}
  \frametitle{Scalar Items in Embedded Positions}
  \begin{block}{Distinguishing Cases \GE \hfill (local)}
...
\begin{frame}
  \frametitle{Next}
  brief summary of previous empirical studies:
  \begin{enumerate}
  \item \citet{GeurtsPouscoulous2009:Embedded-Implic}
  \item \citet{ChemlaSpector2010:Experimental-Ev}
  \item {\color{gray}{\citet{CliftonDube2010:Embedded-Implic}}} \hfill {\color{gray}{(skipped)}}
  \item ``K1''
  \end{enumerate}
\end{frame}
  ...
  \begin{block}{Potential Problems}
    ...
    \item truth-value judgement/rating tasks make it impossible to
      ...
      \item picture~complexity/stereotypicality \hfill
        {\color{gray}{\citep[$\neq$][]{Tielvan-Tiel2012:Embedded-Scalar}}}
      \end{enumerate}
...
\begin{frame}
  ...
  \begin{block}{Design}
    \begin{itemize}
    \item visually-incremental \acro{tv}-judgement task \hfill {\color{gray}{(new?)}}
...
\begin{frame}
  ...
  \begin{block}{\AE\ Conditions}
    ...
    \medskip
      ...
      \includegraphics[width=\textwidth]{../../pictures/sound_analysis_ae.png}
...
\begin{frame}
  ...
  \begin{block}{\GE\ Conditions}
    ...
    \medskip
      ...
      \includegraphics[width=\textwidth]{../../pictures/sound_analysis_ge.png}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=\textwidth]{answer-positions-AE.png}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=\textwidth]{answer-positions-GE.png}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Motivation: Understand our Paradigm}
    ...
    \item investigate conditions where preferred reading's \acro{tv}
      can be judged earlier or later than the non-preferred readings \acro{tv}
...
\begin{frame}
  ...
  \begin{block}{Lessons from the \LC-\EC-Conditions}
    ...
    \item in contrast to target-conditions, prosodic cues have
      expected effect
    \end{itemize}
  \end{block}
\end{frame}
