...
\begin{itemize}
\item Traditionalism often does concede that (something like) local
  readings can occur if scalar items are marked with \emph{special
    accentuation}, albeit then as a signal of a different pragmatic
  process
