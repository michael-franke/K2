...
in which kind of picture pairs were presented. Let's look at both in
turn.

In version 1, the picture pair consisted of the weak and strong
situations in Figures~\ref{fig:weak} and
\ref{fig:strong}. \citeauthor{CliftonDube2010:Embedded-Implic} found
that the weak situation (where the local reading is false and the
other readings are true) was almost never selected, as was the option
``neither''. Ca.~60\% of the choices were recorded for option ``both''
and not quite 40\% for the strong situation (where all readings are
true). The majority answer ``both'' is compatible with traditionalism,
but the 40\% of choices for the strong situation, so
\citeauthor{CliftonDube2010:Embedded-Implic} argue, could be taken as
indicative of the availability of the local reading.

In version 2, the picture pair consisted of the literal and weak
situations in Figures~\ref{fig:literal-AE} and \ref{fig:weak}. In this
case, answer choices were more homogeneously distributed, but still
showed a significant tendency towards, as we would interpret it,
traditionalism. This is because the option ``both'' was the majority
answer with ca.~50\% of answers given.



[They actually say that the reading is preferred because we choose the
one that satisfies it]

As for version 2 of their experiment, most  
