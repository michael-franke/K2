...
In sum, if the interpretation of our data as suggested here is correct
(we will argue presently that it is), then both traditionalism and
grammaticalism are in need of revision. Traditionalism must explain
the availability of local readings, grammaticalism must revise its
selection criterion among readings. 
