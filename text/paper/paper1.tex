...
variation (Augurzky, 2008; Bader, 1998; Fodor98, 2000, 2001; Kentner,
...
the \acro{pp} can be attached to the whole conjoined \acro{np}
...
\paragraph{Testing Effects of prosody.}\dn{These two paragraphs
  ...
  - Petra's comment: wenn wir's wie jetzt etwas ausführlicher diskutieren, 
  kann's auch gerne hier bleiben} 
...
(59 \%), but were not affected by capitalizing. \fn{Note that, 
unfortunately, the authors do not provide percentages for the embedded 
conditions alone, but only the means across sentence types.} The authors 
...
To test whether prosodic information is taken into account in the \acro{itv} task, we
...
Appendix~\ref{sec:audit-sent-mater}. \dn{Petras Kommentar: Vielleicht sollten wir hier jeweils 1 Figure für akzentuiert vs. nicht und boundary vs. nicht reinbringen. Fabian meint zurecht, dass man nicht einfach die Ergebnisse nur in den Appendix packen kann. Es wären dann halt 4 Figures, da wir ja f0 und duration ansehen, und wir würden nur die experimentell interessanten veranschaulichen und die Statistik dann im Appendix lassen - was meint Ihr?} 
