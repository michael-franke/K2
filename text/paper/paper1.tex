...
\paragraph{\as- and \es-sentences and positional controls}

We constructed a set of 15 items for \as- and \es-sentences, respectively,
analogous to the examples in ... and .. 

Sentences were introduced by a subject DP, including the quantifiers 
...
a PP containing {\it einige}, a possessive pronoun, and a noun denoting 
a geometrical object, e.g. a triangle or a square. Each sentence was recorded 
with a stressed and an unstressed version of scalar "some" (see section xx 
below). As described in section ..., three control sentences were created 
for each experimental item, corresponding to the critical positions. 

Items were evenly distributed across 5 lists using a Latin square design.


\paragraph{Preference-related controls}
For controlling preferences, 28 ambiguous Late closure sentences and 28 
of their disambiguated counterparts were constructed as described in Section ... 
In these sentences, subject DPs were always denoting icons and were followed
by an auxiliary. In the ambiguous sentences, the auxiliary was followed by two PPs.
The first of these PPs consisted in a coordination of two geometrical 
objects, whereas the second PP denoted an icon again. In contrast to these 
sentences, the first part of the conjunct in the unambiguous sentences,was 
...
In sum, our speaker reliably produced (i) differences in accent realization for the target sentences and (ii) different boundary realizations for the target- related fillers.
Whereas accented elements clearly differed from their unac-
cented counterpart by showing an increase in duration and F0 range, prosodic
boundaries for our target-related fillers were realized by pre-final lengthening
