...
readings are explained away, traditionalism also looses the
possibility of accounting for local readings of \as-sentences in its
unrestricted variety.\fn{Remember that what we called unrestricted
  traditionalism can account for local readings of \as-sentences by
...
traditionalism cannot explain local readings for \es-sentences at
all. In sum, traditionalism alone cannot explain
...
contradict the strongest meaning hypothesis in either of its suggested
varieties.
