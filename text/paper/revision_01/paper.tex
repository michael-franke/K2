...
``core theory.'' While there are certainly other varieties
conceivable, they are, in our perception, the most prominent ones,
but, more importantly, also the most practical ones in that they give
us precise and testable \emph{ex ante} predictions about expected
behavioral data (as opposed to \emph{ex post} explanations after
inspecting the data). The predictions of the considered core theories
plus their auxiliary assumptions are summarized in
Table~\ref{tab:predictions} on page~\pageref{tab:predictions}. Below,
in Section~\ref{sec:critical-reflection}), further conceivable
varieties of traditionalism and grammaticalism will be discussed
\emph{after} inspecting the relevant data.
