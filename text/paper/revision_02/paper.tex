...
\begin{abstract}
  ...
  out to be unexpected under a traditional Gricean view, but also challenge the idea of
...
would therefore predict that local readings are available forK \es-sentences, but only if
