...
The last kind of disambiguation approach does yield clear predictions
of reading preferences for the case at hand. It selects
...
\emph{incremental verification task} (\acro{ivt}), which is a
